...
{/* 
<div>
  <span><img src="src/assets/headerImage.png" alt="" classN="absolute inset-0 w-full h-full object-cover" loading="lazy" />
  <h1 className="flex-auto text-lg font-semibold text-right text-slate-900">
